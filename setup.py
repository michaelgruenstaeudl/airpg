...
setuptools.setup(
    ...
    download_url='https://github.com/michaelgruenstaeudl/airpg/archive/v0.1.7.tar.gz',
    classifiers=[
    ...
    entry_points={
      "console_scripts": ["airpg-retrieve=airpg.scripts.airpg_retrieve:main", "airpg-analyze=aripg.scripts.airpg_analyze:main", "airpg-make-blacklist=airpg.scripts.airpg_generate_blacklist:main"]
    },
